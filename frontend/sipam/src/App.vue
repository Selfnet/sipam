<template>
  <div id="app">
    <b-navbar toggleable="lg" type="light" sticky variant="light">
      <b-navbar-brand to="/">
        <img src="./assets/imgs/logo.svg" alt="Selfnet Logo" height="32" /> IPAM
      </b-navbar-brand>
      ...
      <b-collapse id="nav-collapse" is-nav>
        ...
        <b-navbar-nav class="ml-auto">
          <b-nav-form>
            <b-form-input size="sm" class="mr-sm-2" :placeholder="$t('GENERAL.SEARCH.PLACEHOLDER')" v-model=query></b-form-input>
            <b-button size="sm" class="my-2 my-sm-0" type="submit">{{$t("GENERAL.BUTTON.SEARCH")}}</b-button>
          </b-nav-form>
          <language-picker />
