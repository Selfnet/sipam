        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True,
                                             on_delete=django.db.models.deletion.CASCADE, related_name='children', to='sipam.Prefix')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, related_name='ips', to='sipam.Prefix')),
            ],
            options={
                'ordering': ('ip',),
            },
